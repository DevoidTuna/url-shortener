  ...
  <main>
    <v-expansion-panels class="w-100" variant="popout">
      ...
      >
        ...
        <v-expansion-panel-text class="rounded-lg py-3 px-1">
          <v-row class="d-block">
          ...
          <v-row>
            <!-- visibility -->
            <v-col class="border border-primary">
              <h3>
                <v-icon
                  :icon="url.public ? 'mdi-eye-outline' : 'mdi-eye-off-outline'"
                />
                Visibility
              </h3>
              <v-radio-group
                v-model="url.public"
                :disabled="load"
                class="border-primary border d-flex"
              >
                <v-radio color="primary" label="Public" :value="1" />
                <v-radio color="primary" label="Private" :value="0" />
              </v-radio-group>
            </v-col>
            ...
            <v-col>
              <h3>
                <v-icon :icon=" url.expired_at == -1 ? 'mdi-timer-off-outline' : 'mdi-timer-outline'" />
                Expiration
              </h3>
              <v-radio-group class="d-flex flex-row border border-primary w-100" v-model="url.expired_at" :disabled="load">
                <v-radio class="border border-primary" color="primary" label="Never" :value="-1" />
                <v-radio class="border border-primary" color="primary" label="45 min" :value="45" />
                <v-radio class="border border-primary" color="primary" label="Custom" :value="'custom'" />
