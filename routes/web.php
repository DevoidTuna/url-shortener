...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/user/delete-url', [LinkController::class, 'deleteUrl'])->name('delete-url');
    ...
    Route::post('/profile/update-password', [UserController::class, 'updatePassword'])->name('do-update-password');    
});
...
Route::get('/login', [UserController::class, 'getLoginPage'])->name('page.login')->middleware('guest');

Route::post('/login', [UserController::class, 'doLogin'])->name('do-login')->middleware('guest');

Route::get('/not-found', [LinkController::class, 'notFound'])->name('page.not-found');
...
Route::get('/send-email', [ResetPasswordController::class, 'sendResetEmail'])->name('do-send-password-email');
...
Route::get('/r/{url}', [LinkController::class, 'redirectUrl'])->name('redirect-url');
